...
export type BasePathDOMProps = Omit< React.ComponentProps<'path'>, 'ref'> & {ref?: React.Ref<SVGPathElement>};
...
export const animatableBranchKeys = [
    "d",
    'stroke',
  'strokeWidth'
] as const;
...
return ( <animated.path {...rest}  {...(animatedValues) as AnimatedProps<BasePathDOMProps>}  />) 
    }
