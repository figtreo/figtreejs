...
(ShapeComponent:React.FC< T & {clade:Clade}>)
    : React.FC<CladeProps<T>>  {
        ...
        const {clades,keyBy=(n:NodeRef)=>n._id,attrs={}, interactions={}} = props
    ...
    withClades.displayName =
    `withCladessArray(${ShapeComponent.displayName || ShapeComponent.name || 'Component'})`;
    return withClades
