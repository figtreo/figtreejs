    ...
    <div className="header">
        ...
        <img
          ...
          onClick={() => {
            if (selectionRoot && selectionMode !== "Taxa") {
              let cartoon: boolean | undefined = tree.getAnnotation(
      ...
      <div className={optionClasses}>
        <img
          ...
          onClick={() => {
            if (selectionRoot && selectionMode !== "Taxa") {
              let collapse: number | undefined = tree.getAnnotation(
                tree.getNode(selectionRoot),
                COLLAPSE_ANNOTATION,
              )
          ...
          onClick={() => {
            if (selectionRoot) {
              if (selectionMode === "Node") {
                dispatch(
                  setTree(tree.rotate(tree.getNode(selectionRoot), false)),
                )
              } else if (selectionMode === "Clade") {
                dispatch(
                  setTree(tree.rotate(tree.getNode(selectionRoot), true)),
                )
              }
            }
          }}
          ...
          <div className="optionContainer">
            <div
              className={`selectionOption ${
                selectionMode === "Node" ? "selected" : ""
              }`}
              onClick={() => dispatch(setSelectionMode("Node"))}
            >
              <p>Node</p>
            </div>
            <div
              className={`selectionOption ${
                selectionMode === "Clade" ? "selected" : ""
              }`}
              onClick={() => dispatch(setSelectionMode("Clade"))}
            >
              <p>Clade</p>
            </div>
            <div
              className={`selectionOption ${
                selectionMode === "Taxa" ? "selected" : ""
              }`}
              onClick={() => dispatch(setSelectionMode("Taxa"))}
            >
              <p>Taxa</p>
            </div>
          </div>
      ...
      <div className="tool">
        <div className="selectionOptions">
          <div className="optionContainer">
            <div
              className={`selectionOption ${
                previoustreeAvaliable ? "" : "deactivated"
              }`}
            >
              {/*onClick={()=>{if(previoustreeAvaliable){tree.getPreviousTree()}}}>*/}
              <div className="arrow left" />
            </div>
            <div
              className={`selectionOption ${
                nextTreeAvaliable ? "" : "deactivated"
              }`}
            >
              {" "}
              {/*onClick={()=>{if(nextTreeAvaliable){tree.getNextTree()}}}>*/}
