    ...
    return (
        <div>
            <div>
                ...
                <select name="shape" id="shape" onChange={e => dispatch(setShape(e.target.value))} value={settings.shape}>
                    {options}
                </select>
            </div>
            <div>
                ...
                <input name="maxSize" id="maxSize" min={0} type="number" value={settings.maxSize} onChange={e => dispatch(setMaxSize(e.target.value))} />
            </div>
            <div>
                <label htmlFor='sizeBy'>Size By:</label>

                <select name="sizeBy" id="sizeBy" onChange={e => dispatch(setSizeBy(e.target.value))} value={settings.sizeBy}>
                    {options}
                </select>
            </div>
            <div>
                ...
                <input name="minSize" id="minSize" min={0} type="number" value={settings.minSize} onChange={e => dispatch(setMinSize(e.target.value))} />
            </div>
            <div>
            ...
            <div>
                ...
                <input name="outlineWidth" id="outlineWidth" min={0} type="number" value={settings.outlineWidth} onChange={e => dispatch(setOutlineWidth(e.target.value))} />
            </div>
            <div>
                <label htmlFor='outlineColour'>Outline Colour: </label>

                <input name="outlineColour" id="outlineColour" value={settings.outlineColour} onChange={e => dispatch(setOutlineColour(e.target.value))} />
            </div>
        </div>
    )
